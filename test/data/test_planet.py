...
def test_serialize_returnsExpectedTuple():
    expected = (1, "TestPlanet", "A2", 2, 3, 4, 5, 6, "A planet")
    planet = Planet(ID=1, name="TestPlanet", coords="A2", tl=2, bio=3, atmos=4, temp=5, pop=6, description="A planet")
    serialized = planet.serialize()
    assert expected == serialized

def test_deserialize_returnsExpectedPlanet():
    serialized = (1, "TestPlanet", "A2", 2, 3, 4, 5, 6, "A planet")
